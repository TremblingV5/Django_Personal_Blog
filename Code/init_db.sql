...
-- ----------------------------
-- Records of articles_articlecategories
-- ----------------------------
INSERT INTO `articles_articlecategories` VALUES (1, 'Python', NULL, 1, '2021-04-23 05:19:49.589202', '2021-05-13 05:47:07.883616', 1);
INSERT INTO `articles_articlecategories` VALUES (2, 'Java', NULL, 1, '2021-04-23 05:22:25.010110', '2021-05-13 05:47:08.696151', 1);
INSERT INTO `articles_articlecategories` VALUES (3, 'C++', NULL, 1, '2021-04-23 05:22:35.907289', '2021-05-13 05:47:09.171175', 1);
...
-- ----------------------------
-- Records of articles_articles
-- ----------------------------
INSERT INTO `articles_articles` VALUES (15, '测试文章', '这是一篇测试文章，测试一下能否正常解析markdown', '[TOC]\r\n\r\n\r\n\r\n\r\n# H1\r\n\r\n## H2\r\n\r\n### H3\r\n\r\n#### H4\r\n\r\n##### H5\r\n\r\n###### H6\r\n\r\n*Italic*\r\n\r\n**Bold**\r\n\r\n***Bold&Italic***\r\n\r\n---\r\n\r\n~~Delete Line~~\r\n\r\n<u>Underline</u>[^1]\r\n\r\n- A\r\n- B\r\n- C\r\n\r\n> Block\r\n\r\n```python\r\nclass Test:\r\n	def __init__(self):\r\n		a = \"test\"\r\n		\r\n	@staticmethod\r\n	def test(a) -> int:\r\n		return int(a)\r\n\r\nif __name__ == \"__main__\":\r\n	instance = Test()\r\n	print(instance.test(5))\r\n```\r\n\r\n> ```python\r\n> print(\"Hello world\")\r\n> ```\r\n\r\n[BAIDU](https://www.baidu.com)\r\n\r\n<https://www.baidu.com>\r\n\r\n| A    | B    | C    | D    |\r\n| ---- | ---- | ---- | ---- |\r\n| A    | B    | C    | D    |\r\n| A    | B    | C    | D    |\r\n\r\n$$\r\nA_n^m = n(n-1)\\cdots(n-m+1) = \\frac{n!}{(n-m)!}\r\n$$\r\n\r\n```sequence\r\nAndrew->China: Says Hello \r\nNote right of China: China thinks\\nabout it \r\nChina-->Andrew: How are you? \r\nAndrew->>China: I am good thanks!\r\n```\r\n\r\n[^1]:这是一个脚注', 'coverImages/85c62c5bf32a19ddbe91e684d26ec467.png', 1, '2021-04-28 09:55:41.941552', '2021-05-13 06:55:38.190844', 2, 1, 1);
INSERT INTO `articles_articles` VALUES (16, '分类测试-C++', 'C++测试，分类界面', '[TOC]\r\n\r\n\r\n\r\n\r\n# H1\r\n\r\n## H2\r\n\r\n### H3\r\n\r\n#### H4\r\n\r\n##### H5\r\n\r\n###### H6\r\n\r\n*Italic*\r\n\r\n**Bold**\r\n\r\n***Bold&Italic***\r\n\r\n---\r\n\r\n~~Delete Line~~\r\n\r\n<u>Underline</u>[^1]\r\n\r\n- A\r\n- B\r\n- C\r\n\r\n> Block\r\n\r\n```python\r\nclass Test:\r\n	def __init__(self):\r\n		a = \"test\"\r\n		\r\n	@staticmethod\r\n	def test(a) -> int:\r\n		return int(a)\r\n\r\nif __name__ == \"__main__\":\r\n	instance = Test()\r\n	print(instance.test(5))\r\n```\r\n\r\n> ```python\r\n> print(\"Hello world\")\r\n> ```\r\n\r\n[BAIDU](https://www.baidu.com)\r\n\r\n<https://www.baidu.com>\r\n\r\n| A    | B    | C    | D    |\r\n| ---- | ---- | ---- | ---- |\r\n| A    | B    | C    | D    |\r\n| A    | B    | C    | D    |\r\n\r\n$$\r\nA_n^m = n(n-1)\\cdots(n-m+1) = \\frac{n!}{(n-m)!}\r\n$$\r\n\r\n```sequence\r\nAndrew->China: Says Hello \r\nNote right of China: China thinks\\nabout it \r\nChina-->Andrew: How are you? \r\nAndrew->>China: I am good thanks!\r\n```\r\n\r\n[^1]:这是一个脚注', 'coverImages/d975cfef2e1c26c87020c4c883eb4632.png', 1, '2021-04-28 09:57:00.638849', '2021-05-13 06:55:39.493823', 1, 1, 1);
INSERT INTO `articles_articles` VALUES (17, '分类测试 Java', '其实这篇文章的分类是C++', '[TOC]\r\n\r\n\r\n\r\n\r\n# H1\r\n\r\n## H2\r\n\r\n### H3\r\n\r\n#### H4\r\n\r\n##### H5\r\n\r\n###### H6\r\n\r\n*Italic*\r\n\r\n**Bold**\r\n\r\n***Bold&Italic***\r\n\r\n---\r\n\r\n~~Delete Line~~\r\n\r\n<u>Underline</u>[^1]\r\n\r\n- A\r\n- B\r\n- C\r\n\r\n> Block\r\n\r\n```python\r\nclass Test:\r\n	def __init__(self):\r\n		a = \"test\"\r\n		\r\n	@staticmethod\r\n	def test(a) -> int:\r\n		return int(a)\r\n\r\nif __name__ == \"__main__\":\r\n	instance = Test()\r\n	print(instance.test(5))\r\n```\r\n\r\n> ```python\r\n> print(\"Hello world\")\r\n> ```\r\n\r\n[BAIDU](https://www.baidu.com)\r\n\r\n<https://www.baidu.com>\r\n\r\n| A    | B    | C    | D    |\r\n| ---- | ---- | ---- | ---- |\r\n| A    | B    | C    | D    |\r\n| A    | B    | C    | D    |\r\n\r\n$$\r\nA_n^m = n(n-1)\\cdots(n-m+1) = \\frac{n!}{(n-m)!}\r\n$$\r\n\r\n```sequence\r\nAndrew->China: Says Hello \r\nNote right of China: China thinks\\nabout it \r\nChina-->Andrew: How are you? \r\nAndrew->>China: I am good thanks!\r\n```\r\n\r\n[^1]:这是一个脚注', 'coverImages/4afea736b6e855587af08a56fde86190.png', 1, '2021-04-28 09:57:40.584629', '2021-05-13 06:55:40.359820', 3, 1, 1);
...
-- ----------------------------
INSERT INTO `blog_aboutme` VALUES (1, '[个人自述]', 1, 0, '2021-04-27 00:00:00.000000', '2021-04-05 00:00:00.000000');
INSERT INTO `blog_aboutme` VALUES (3, '# Test', 1, 0, '2021-04-22 15:26:44.499777', '2021-04-22 15:26:44.499777');
INSERT INTO `blog_aboutme` VALUES (4, '# Test\r\n- 1\r\n- 2\r\n- 3\r\n- 4', 1, 0, '2021-04-22 15:26:53.127909', '2021-04-22 15:26:53.127909');
INSERT INTO `blog_aboutme` VALUES (5, '# Test', 1, 0, '2021-04-22 15:28:46.959006', '2021-04-22 15:28:46.959006');
INSERT INTO `blog_aboutme` VALUES (6, '# Test', 1, 0, '2021-04-22 15:29:26.295148', '2021-04-22 15:29:26.295148');
INSERT INTO `blog_aboutme` VALUES (7, '# Test', 1, 0, '2021-04-22 15:40:02.190247', '2021-04-22 15:40:02.190247');
INSERT INTO `blog_aboutme` VALUES (8, '# Test', 1, 0, '2021-04-22 15:41:16.413010', '2021-04-22 15:41:16.413010');
INSERT INTO `blog_aboutme` VALUES (9, '# Test', 1, 0, '2021-04-22 15:41:36.703673', '2021-04-22 15:41:36.703673');
INSERT INTO `blog_aboutme` VALUES (10, '# Test', 1, 0, '2021-04-22 15:41:59.601057', '2021-04-22 15:41:59.601057');
INSERT INTO `blog_aboutme` VALUES (11, '# Test', 1, 0, '2021-04-22 15:43:37.748620', '2021-04-22 15:43:37.748620');
INSERT INTO `blog_aboutme` VALUES (12, '# Test', 1, 0, '2021-04-22 15:44:11.500129', '2021-04-22 15:44:11.500129');
INSERT INTO `blog_aboutme` VALUES (13, '# Test', 1, 0, '2021-04-22 15:44:22.808139', '2021-04-22 15:44:22.808139');
INSERT INTO `blog_aboutme` VALUES (14, '# Test', 1, 0, '2021-04-22 15:44:44.349321', '2021-04-22 15:44:44.349321');
INSERT INTO `blog_aboutme` VALUES (15, '# Test', 1, 0, '2021-04-22 15:45:07.428177', '2021-04-22 15:45:07.428177');
INSERT INTO `blog_aboutme` VALUES (16, '# Test\r\n123456', 1, 0, '2021-04-22 15:45:15.041527', '2021-04-22 15:45:15.041527');
...
-- ----------------------------
INSERT INTO `manager_adminuser` VALUES (1, 'xinzf', 'xzf516608810', 'test', '13355556666', 'test@test.com');
INSERT INTO `manager_adminuser` VALUES (2, 'admin', 'root', 'test', '13355556666', 'test@test.com');
...
-- ----------------------------
INSERT INTO `resume_basicinfo` VALUES (1, '辛正非', 'R&D Engineer', '202111', '2021-04-19', '13835530520', 'zf.xin@qq.com', 'http://zhengfei.xin', '略', 1, 1, '2021-04-19 00:00:00.000000', '2021-05-13 05:46:53.665548', '', '', '');
INSERT INTO `resume_basicinfo` VALUES (3, '辛正非', '1383553052', 'Test', '2021-04-16', '13835530520', '1340349413@qq.com', 'http://www.baidu.com', '康沿路418号文怡苑二期南门2号1103', 0, 1, '2021-04-22 04:52:39.142495', '2021-04-22 13:16:52.340482', NULL, NULL, NULL);
INSERT INTO `resume_basicinfo` VALUES (4, 'Test', '1383553052', 'Test', '1909-09-06', '13835530520', '1340349413@qq.com', 'http://www.baidu.com', '康沿路418号文怡苑二期南门2号1103', 0, 1, '2021-04-22 08:52:05.260998', '2021-04-22 13:16:48.460957', NULL, NULL, NULL);
...
-- ----------------------------
-- Records of resume_capabilitystack
-- ----------------------------
INSERT INTO `resume_capabilitystack` VALUES (1, 'Test', 25, 1, 1, '2021-04-22 13:29:56.207480', '2021-04-22 13:30:08.708808');
INSERT INTO `resume_capabilitystack` VALUES (2, 'Python', 25, 1, 1, '2021-04-22 13:30:34.316902', '2021-05-13 05:47:00.480688');
INSERT INTO `resume_capabilitystack` VALUES (3, 'Vue', 12, 1, 1, '2021-04-22 13:30:42.453290', '2021-04-23 02:13:02.976405');
INSERT INTO `resume_capabilitystack` VALUES (4, 'Redis', 30, 1, 1, '2021-04-22 13:30:59.103105', '2021-05-13 05:47:01.208946');
INSERT INTO `resume_capabilitystack` VALUES (5, 'C++', 100, 0, 1, '2021-04-22 13:31:06.343117', '2021-05-13 05:47:01.769601');
...
-- ----------------------------
-- Records of resume_resume
-- ----------------------------
INSERT INTO `resume_resume` VALUES (1, '江西理工大学-南昌校区', '毕业于能源与机械工程学院-软件工程专业', '2015-09-01', '2019-06-17', 0, 'edu', 1, 1, '2021-04-19 00:00:00.000000', '2021-05-13 05:46:55.852593');
INSERT INTO `resume_resume` VALUES (3, '微电影社区', 'Test', '2021-04-04', '2021-04-23', 1, 'job', 1, 1, '2021-04-23 02:04:24.866907', '2021-04-23 02:14:18.635315');
INSERT INTO `resume_resume` VALUES (4, 'Google', 'Google', '2021-04-01', '2021-04-15', 0, 'job', 1, 1, '2021-04-23 05:05:18.972269', '2021-05-13 05:46:57.691620');
